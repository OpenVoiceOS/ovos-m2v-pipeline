...
def main() -> int:
    ...
    # skill folds intents (date-time, randomness and wallpapers renamed to
    # underscored base names, volume and weather consolidated into slot
    # intents, the it-IT count case fix); every such fold is accounted for
    # in knowledge/wiki/audits/m2v-training/v6-label-floor-diff.md of the
    # AgentWorkspaces wiki before the floor moves.
    ap.add_argument("--min-labels", type=int, default=224)
