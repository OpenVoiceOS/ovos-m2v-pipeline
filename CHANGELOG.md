...
- fix: validate model snapshot against the Hub when no revision is pinned [\#110](https://github.com/OpenVoiceOS/ovos-m2v-pipeline/pull/110) ([JarbasAl](https://github.com/JarbasAl))
